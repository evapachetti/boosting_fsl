...
for epoch in {100,400}; do
    for bs in {128,256,512}; do
        for wd in {0.01,0.001,0.0001}; do
            ...
            OUTPUT_MODEL_PATH=~/ssl_trainings/deepBDC/finetuned_models_additional/5-shot/$METATEST_DATASET/ipirm_coarse_picai/$OUTPUT_FOLDER
            ...
            --metatest_dataset "$METATEST_DATASET" --pretrain_method IPIRM --model "$MODEL" \
