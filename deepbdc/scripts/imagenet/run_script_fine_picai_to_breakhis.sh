...
OUTPUT_MODEL_PATH=~/ssl_trainings/deepBDC/finetuned_models_additional/5-shot/$METATEST_DATASET/imagenet_fine_picai/$OUTPUT_FOLDER
...
--csv_path_test "$TEST_PATH" --image_size 128 --n_shot 5 --n_query 10 --test_n_way 2 --reduce_dim 256 --test_n_episode 100 
--test_task_nums 5
