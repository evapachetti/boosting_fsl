...
#%% PICAI
class PICAIDatasetSSL(data.Dataset):

    """
    Custom Dataset for loading and preprocessing the PI-CAI dataset for SSL training.
    ...
    def __init__(self, csv_path, folder_name = "unsupervised"):
...
class ToTensorPICAIDatasetSSL(torch.utils.data.Subset):
    """
...
class BREAKHISDatasetSSL(data.Dataset):
    """
...
class ToTensorBREAKHISDatasetSSL(torch.utils.data.Subset):
    """
